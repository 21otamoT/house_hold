...
interface HomeProps {
  ...
  onSaveTrqnsaction: (transaction: Schema) => Promise<void>
}

const Home = ({monthlyTransactions, setCurrentMouth, onSaveTrqnsaction}: HomeProps) => {
    ...
    <Box sx={{display: 'flex'}}>
      ...
      <Box>
        ...
        <TransactionForm 
          ...
          onSaveTransaction={onSaveTrqnsaction}
        />
      </Box>
    </Box>
  )
