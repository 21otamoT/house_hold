...
import { ExpenseCategory, Transaction, TransactionType, incomeCategory } from '../types';
...
const CategoryChart = ({monthlyTransactions, isLoading}: CategoryChartProps) => {
  ...
  const getCategoryColor = (category: incomeCategory | ExpenseCategory) => {
    switch(selectedType) {
      case 'income': return incomeCategoryColor[category as incomeCategory]
      default : return expenseCategoryColor[category as ExpenseCategory]
    }
  }
